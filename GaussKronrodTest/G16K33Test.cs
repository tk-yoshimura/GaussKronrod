...
namespace GaussKronrodTest {
    public class G16K33Test<N> where N : struct, IConstant {
        static readonly ReadOnlyCollection<MultiPrecision<N>> x, w1, w2;

        static G16K33Test() {
            (MultiPrecision<N>[] x_plus1, MultiPrecision<N>[] w1_plus1, MultiPrecision<N>[] w2_plus1) = CoefGenaratorMP<N, Plus32<N>>.Coef(16);
        ...
        public static void WriteText() {
            using StreamWriter sw = new($"../../../../results/G16K33_n{MultiPrecision<N>.Length}.csv");
        ...
        public static void WriteHexcode() {
            using StreamWriter sw = new($"../../../../results/G16K33_hexcode.txt");

            sw.WriteLine("{ 16, new ReadOnlyCollection<(ddouble x, ddouble wg, ddouble wk)>(new (ddouble x, ddouble wg, ddouble wk)[]{");
        ...
        public static void WriteBinary() {
            using BinaryWriter sw = new(File.Open($"../../../../results/G16K33_n{MultiPrecision<N>.Length}.bin", FileMode.Create));
    ...
    [TestClass]
    public class G16K33N8Test {
        [TestMethod]
        public void PolyTest() {
            G16K33Test<Pow2.N8>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G16K33Test<Pow2.N8>.SumTest();
        }

        [TestMethod]
        public void WriteText() {
            G16K33Test<Pow2.N8>.WriteText();
            G16K33Test<Pow2.N8>.WriteHexcode();
        }

        [TestMethod]
        public void WriteBinary() {
            G16K33Test<Pow2.N8>.WriteBinary();
        }
    }

    [TestClass]
    public class G16K33N16Test {
        [TestMethod]
        public void PolyTest() {
            G16K33Test<Pow2.N16>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G16K33Test<Pow2.N16>.SumTest();
        }
    }

    [TestClass]
    public class G16K33N32Test {
        [TestMethod]
        public void PolyTest() {
            G16K33Test<Pow2.N32>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G16K33Test<Pow2.N32>.SumTest();
        }
    }

    [TestClass]
    public class G16K33N64Test {
        [TestMethod]
        public void PolyTest() {
            G16K33Test<Pow2.N64>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G16K33Test<Pow2.N64>.SumTest();
        }

        [TestMethod]
        public void WriteBinary() {
            G16K33Test<Pow2.N64>.WriteBinary();
        }
    }
}