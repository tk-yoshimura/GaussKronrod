...
namespace GaussKronrodTest {
    public class G4K9Test<N> where N : struct, IConstant {
        static readonly ReadOnlyCollection<MultiPrecision<N>> x, w1, w2;

        static G4K9Test() {
            (MultiPrecision<Plus4<N>>[] x_plus1, MultiPrecision<Plus4<N>>[] w1_plus1, MultiPrecision<Plus4<N>>[] w2_plus1) = CoefGenaratorMP<Plus4<N>>.Coef(4);
        ...
        public static void WriteText() {
            using StreamWriter sw = new($"../../../../results/G4K9_n{MultiPrecision<N>.Length}.csv");
        ...
        public static void WriteHexcode() {
            using StreamWriter sw = new($"../../../../results/G4K9_hexcode.txt");

            sw.WriteLine("{ 4, new ReadOnlyCollection<(ddouble x, ddouble wg, ddouble wk)>(new (ddouble x, ddouble wg, ddouble wk)[]{");
        ...
        public static void WriteBinary() {
            using BinaryWriter sw = new(File.Open($"../../../../results/G4K9_n{MultiPrecision<N>.Length}.bin", FileMode.Create));
    ...
    [TestClass]
    public class G4K9N8Test {
        [TestMethod]
        public void PolyTest() {
            G4K9Test<Pow2.N8>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G4K9Test<Pow2.N8>.SumTest();
        }

        [TestMethod]
        public void WriteText() {
            G4K9Test<Pow2.N8>.WriteText();
            G4K9Test<Pow2.N8>.WriteHexcode();
        }

        [TestMethod]
        public void WriteBinary() {
            G4K9Test<Pow2.N8>.WriteBinary();
        }
    }

    [TestClass]
    public class G4K9N16Test {
        [TestMethod]
        public void PolyTest() {
            G4K9Test<Pow2.N16>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G4K9Test<Pow2.N16>.SumTest();
        }
    }

    [TestClass]
    public class G4K9N32Test {
        [TestMethod]
        public void PolyTest() {
            G4K9Test<Pow2.N32>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G4K9Test<Pow2.N32>.SumTest();
        }
    }

    [TestClass]
    public class G4K9N64Test {
        [TestMethod]
        public void PolyTest() {
            G4K9Test<Pow2.N64>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G4K9Test<Pow2.N64>.SumTest();
        }

        [TestMethod]
        public void WriteBinary() {
            G4K9Test<Pow2.N64>.WriteBinary();
        }
    }
}