...
namespace GaussKronrodTest {
    public class G3K7Test<N> where N : struct, IConstant {
        static readonly ReadOnlyCollection<MultiPrecision<N>> x, w1, w2;

        static G3K7Test() {
            (MultiPrecision<Plus2<N>>[] x_plus1, MultiPrecision<Plus2<N>>[] w1_plus1, MultiPrecision<Plus2<N>>[] w2_plus1) = CoefGenaratorMP<Plus2<N>>.Coef(3);
        ...
        public static void WriteText() {
            using StreamWriter sw = new($"../../../../results/G3K7_n{MultiPrecision<N>.Length}.csv");
        ...
        public static void WriteHexcode() {
            using StreamWriter sw = new($"../../../../results/G3K7_hexcode.txt");

            sw.WriteLine("{ 3, new ReadOnlyCollection<(ddouble x, ddouble wg, ddouble wk)>(new (ddouble x, ddouble wg, ddouble wk)[]{");
        ...
        public static void WriteBinary() {
            using BinaryWriter sw = new(File.Open($"../../../../results/G3K7_n{MultiPrecision<N>.Length}.bin", FileMode.Create));
    ...
    [TestClass]
    public class G3K7N8Test {
        [TestMethod]
        public void PolyTest() {
            G3K7Test<Pow2.N8>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G3K7Test<Pow2.N8>.SumTest();
        }

        [TestMethod]
        public void WriteText() {
            G3K7Test<Pow2.N8>.WriteText();
            G3K7Test<Pow2.N8>.WriteHexcode();
        }

        [TestMethod]
        public void WriteBinary() {
            G3K7Test<Pow2.N8>.WriteBinary();
        }
    }

    [TestClass]
    public class G3K7N16Test {
        [TestMethod]
        public void PolyTest() {
            G3K7Test<Pow2.N16>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G3K7Test<Pow2.N16>.SumTest();
        }
    }

    [TestClass]
    public class G3K7N32Test {
        [TestMethod]
        public void PolyTest() {
            G3K7Test<Pow2.N32>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G3K7Test<Pow2.N32>.SumTest();
        }
    }

    [TestClass]
    public class G3K7N64Test {
        [TestMethod]
        public void PolyTest() {
            G3K7Test<Pow2.N64>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G3K7Test<Pow2.N64>.SumTest();
        }

        [TestMethod]
        public void WriteBinary() {
            G3K7Test<Pow2.N64>.WriteBinary();
        }
    }
}