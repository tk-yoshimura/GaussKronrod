...
namespace GaussKronrodTest {
    public class G30K61Test<N> where N : struct, IConstant {
        static readonly ReadOnlyCollection<MultiPrecision<N>> x, w1, w2;

        static G30K61Test() {
            (MultiPrecision<Plus2<N>>[] x_plus1, MultiPrecision<Plus2<N>>[] w1_plus1, MultiPrecision<Plus2<N>>[] w2_plus1) = CoefGenaratorMP<Plus2<N>>.Coef(30);
        ...
        public static void WriteText() {
            using StreamWriter sw = new($"../../../../results/G30K61_n{MultiPrecision<N>.Length}.csv");
        ...
        public static void WriteHexcode() {
            using StreamWriter sw = new($"../../../../results/G30K61_hexcode.txt");

            sw.WriteLine("{ 30, new ReadOnlyCollection<(ddouble x, ddouble wg, ddouble wk)>(new (ddouble x, ddouble wg, ddouble wk)[]{");
        ...
        public static void WriteBinary() {
            using BinaryWriter sw = new(File.Open($"../../../../results/G30K61_n{MultiPrecision<N>.Length}.bin", FileMode.Create));
    ...
    [TestClass]
    public class G30K61N8Test {
        [TestMethod]
        public void PolyTest() {
            G30K61Test<Pow2.N8>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G30K61Test<Pow2.N8>.SumTest();
        }

        [TestMethod]
        public void WriteText() {
            G30K61Test<Pow2.N8>.WriteText();
            G30K61Test<Pow2.N8>.WriteHexcode();
        }

        [TestMethod]
        public void WriteBinary() {
            G30K61Test<Pow2.N8>.WriteBinary();
        }
    }

    [TestClass]
    public class G30K61N16Test {
        [TestMethod]
        public void PolyTest() {
            G30K61Test<Pow2.N16>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G30K61Test<Pow2.N16>.SumTest();
        }
    }

    [TestClass]
    public class G30K61N32Test {
        [TestMethod]
        public void PolyTest() {
            G30K61Test<Pow2.N32>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G30K61Test<Pow2.N32>.SumTest();
        }
    }

    [TestClass]
    public class G30K61N64Test {
        [TestMethod]
        public void PolyTest() {
            G30K61Test<Pow2.N64>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G30K61Test<Pow2.N64>.SumTest();
        }

        [TestMethod]
        public void WriteBinary() {
            G30K61Test<Pow2.N64>.WriteBinary();
        }
    }
}