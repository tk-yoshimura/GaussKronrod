...
namespace GaussKronrodTest {
    public class G15K31Test<N> where N : struct, IConstant {
        static readonly ReadOnlyCollection<MultiPrecision<N>> x, w1, w2;

        static G15K31Test() {
            (MultiPrecision<Plus4<N>>[] x_plus1, MultiPrecision<Plus4<N>>[] w1_plus1, MultiPrecision<Plus4<N>>[] w2_plus1) = CoefGenaratorMP<Plus4<N>>.Coef(15);
        ...
        public static void WriteText() {
            using StreamWriter sw = new($"../../../../results/G15K31_n{MultiPrecision<N>.Length}.csv");
        ...
        public static void WriteHexcode() {
            using StreamWriter sw = new($"../../../../results/G15K31_hexcode.txt");

            sw.WriteLine("{ 15, new ReadOnlyCollection<(ddouble x, ddouble wg, ddouble wk)>(new (ddouble x, ddouble wg, ddouble wk)[]{");
        ...
        public static void WriteBinary() {
            using BinaryWriter sw = new(File.Open($"../../../../results/G15K31_n{MultiPrecision<N>.Length}.bin", FileMode.Create));
    ...
    [TestClass]
    public class G15K31N8Test {
        [TestMethod]
        public void PolyTest() {
            G15K31Test<Pow2.N8>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G15K31Test<Pow2.N8>.SumTest();
        }

        [TestMethod]
        public void WriteText() {
            G15K31Test<Pow2.N8>.WriteText();
            G15K31Test<Pow2.N8>.WriteHexcode();
        }

        [TestMethod]
        public void WriteBinary() {
            G15K31Test<Pow2.N8>.WriteBinary();
        }
    }

    [TestClass]
    public class G15K31N16Test {
        [TestMethod]
        public void PolyTest() {
            G15K31Test<Pow2.N16>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G15K31Test<Pow2.N16>.SumTest();
        }
    }

    [TestClass]
    public class G15K31N32Test {
        [TestMethod]
        public void PolyTest() {
            G15K31Test<Pow2.N32>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G15K31Test<Pow2.N32>.SumTest();
        }
    }

    [TestClass]
    public class G15K31N64Test {
        [TestMethod]
        public void PolyTest() {
            G15K31Test<Pow2.N64>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G15K31Test<Pow2.N64>.SumTest();
        }

        [TestMethod]
        public void WriteBinary() {
            G15K31Test<Pow2.N64>.WriteBinary();
        }
    }
}