...
namespace GaussKronrodTest {
    public class G64K129Test<N> where N : struct, IConstant {
        static readonly ReadOnlyCollection<MultiPrecision<N>> x, w1, w2;

        static G64K129Test() {
            (MultiPrecision<Plus4<N>>[] x_plus1, MultiPrecision<Plus4<N>>[] w1_plus1, MultiPrecision<Plus4<N>>[] w2_plus1) = CoefGenaratorMP<Plus4<N>>.Coef(64);
        ...
        public static void WriteText() {
            using StreamWriter sw = new($"../../../../results/G64K129_n{MultiPrecision<N>.Length}.csv");
        ...
        public static void WriteHexcode() {
            using StreamWriter sw = new($"../../../../results/G64K129_hexcode.txt");
        ...
        public static void WriteBinary() {
            using BinaryWriter sw = new(File.Open($"../../../../results/G64K129_n{MultiPrecision<N>.Length}.bin", FileMode.Create));
    ...
    [TestClass]
    public class G64K129N8Test {
        [TestMethod]
        public void PolyTest() {
            G64K129Test<Pow2.N8>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G64K129Test<Pow2.N8>.SumTest();
        }

        [TestMethod]
        public void WriteText() {
            G64K129Test<Pow2.N8>.WriteText();
            G64K129Test<Pow2.N8>.WriteHexcode();
        }

        [TestMethod]
        public void WriteBinary() {
            G64K129Test<Pow2.N8>.WriteBinary();
        }
    }

    [TestClass]
    public class G64K129N16Test {
        [TestMethod]
        public void PolyTest() {
            G64K129Test<Pow2.N16>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G64K129Test<Pow2.N16>.SumTest();
        }
    }

    [TestClass]
    public class G64K129N32Test {
        [TestMethod]
        public void PolyTest() {
            G64K129Test<Pow2.N32>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G64K129Test<Pow2.N32>.SumTest();
        }
    }

    [TestClass]
    public class G64K129N64Test {
        [TestMethod]
        public void PolyTest() {
            G64K129Test<Pow2.N64>.PolyTest();
        }

        [TestMethod]
        public void SumTest() {
            G64K129Test<Pow2.N64>.SumTest();
        }

        [TestMethod]
        public void WriteBinary() {
            G64K129Test<Pow2.N64>.WriteBinary();
        }
    }
}